...
const NavBar = ({ text }) => {
  return (
    <div class="flex flex-row-reverse justify-between  bg-darkBg h-16 px-4 w-screen  max-w-screen">
      ...
      <div>
        <button className="px-5 py-2 w-28 font-medium text-white mt-3 mx-10 bg-blue-600 rounded-lg">
          {text}
        </button>
      </div>
    </div>
